...
class RectangleDarkGreyButton extends StatelessWidget {
  ...
  RectangleDarkGreyButton({this.containerWidth,@required this.content, @required this.onPressed,@required this.type});
